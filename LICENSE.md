...
*The following text is included verbatim, as required.*

**“Commons Clause” License Condition v1.0**

The Software is provided under the terms of the AGPL v3, provided that the Licensor supplements the license with the following additional term:
...
Any licensee wishing to engage in any activity that constitutes “Selling” must obtain a separate commercial license from the Licensor.

Official text: https://commonsclause.com
...
# 3. Dual Licensing Option

A commercial license is available for organisations that require:

- Multi-tenant SaaS usage  
- Closed-source integration  
- Distribution without AGPL obligations  
- Commercial sublicensing  

For commercial licensing, contact: **info@visbo.de**

---

# 4. Full Text of the GNU Affero General Public License v3

To avoid accidental modification and to ensure access to the authoritative original text, the complete AGPL v3 license is available from the Free Software Foundation at:

https://www.gnu.org/licenses/agpl-3.0.txt

This link points to the official, unmodified AGPL v3 license text.
